...
function watchUserPosition() {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.watchPosition(function (position) {
            ...
            // Remove existing marker and routing control
            if (myLocationMarker) {
            ...
            myLocationMarker = L.marker(userLocation).addTo(map);

            // Check if searchMarker exists and routingControl is set
            if (searchMarker && routingControl) {
                // Set routing control to the new user location
